...
本地直接部署Elasticsearch可参考《 [Elasticsearch的安装部署](../notes/classification/6.Elasticsearch/1.Elasticsearch的安装部署.md#Linux安装ElasticSearch) 》

本地直接部署kibana可参考 《[Kibana的安装部署](../notes/classification/6.Elasticsearch/1.Elasticsearch的安装部署.md#Linux安装Kibana) 》

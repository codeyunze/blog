...
permalink: /classification/d2h6ohyh/
---
...
搭建方式：《 [Redis的主从架构配置](11.Redis的主从架构配置.md) 》
...
搭建方式：《  [Redis的哨兵架构配置](12.Redis的哨兵架构配置.md) 》
...
搭建方式：《  [Redis的集群搭建配置](13.Redis的集群搭建配置.md) 》

Redis集群是多主多从。

Redis集群设置16384个哈希槽。每个key会通过CRC16校验后，对16384取模，来决定放到哪个槽。集群的每个节点负责一部分的hash槽。

集群主节点选举原理 《  [Redis的集群的选举原理分析](13.Redis的集群搭建配置.md#集群的选举原理分析) 》

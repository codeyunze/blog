...
permalink: /classification/k80niorf/
tags:
  - Elasticsearch
  - 问题解决方案
---
...
```
原es_test的映射如下图右侧所示；
![在这里插入图片描述](../../../java/images/fdf0a79b57c02102fc3f14f015d126d6.png)
...
```
![在这里插入图片描述](../../../java/images/964347f4492a9d1be337390ce75b6025.png)
...
![在这里插入图片描述](../../../java/images/ae43467d1c188bb95cc350b28fa11f53.png)
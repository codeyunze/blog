        ...
        children: [
            {text: "事务的ACID特性", link: "事务的ACID特性"},
            {
                ...
                children: [
                    ...
                    {
                        text: "为何MySQL选择B+树作为索引结构",
                        icon: "fa-solid fa-leaf",
                        link: "为何MySQL选择B+树作为索引结构"
                    },
                    {text: "MySQL有哪些锁", icon: "fa-solid fa-lock", link: "MySQL有哪些锁"},
                    {text: "MySQL的意向锁", icon: "fa-solid fa-user-lock", link: "MySQL的意向锁"},
                    {
                        text: "事务中的脏读、脏写、不可重复读与幻读详解",
                        icon: "fa-solid fa-shuffle",
                        link: "数据库事务中的四大问题：脏读、脏写、不可重复读与幻读详解"
                    },
                    {
                        text: "MVCC机制解析：提升数据库并发性能的关键",
                        icon: "fa-solid fa-people-arrows",
                        link: "MVCC机制解析：提升数据库并发性能的关键"
                    },
                    {text: "MySQL普通索引与唯一索引的区别", link: "MySQL普通索引与唯一索引的区别"},
                    {
                        text: "MySQL自定义排序ORDER BY FIELD",
                        icon: "fa-solid fa-arrow-down-a-z",
                        link: "MySQL自定义排序：使用ORDER BY FIELD实现灵活的数据排序"
                    },
                ],
            },
            {
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        text: "基础面试必知==和equals()的区别",
                        icon: "fa-solid fa-equals",
                        link: "基础面试必知==和equals()的区别"
                    },
                    {
                        text: "基础面试必知HashMap的数据结构与扩容机制",
                        icon: "fa-solid fa-paste",
                        link: "基础面试必知HashMap的数据结构与扩容机制"
                    },
